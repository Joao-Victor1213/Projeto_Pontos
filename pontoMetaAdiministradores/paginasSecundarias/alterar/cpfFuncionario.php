    ...
    if(isset($_GET['erro'])){
        ...
        switch ($erro) {
            ...
            case 1:
                ...
                break;
            case 2:
                $erro = 'NÃO FOI POSSIVEL ATUALIZAR, TALVEZ ESTE CPF NÃO EXISTA NO BANCO';
                break;
            case 3:
...
<body>
    ...
    <form method = "POST" id = 'formNovoUsuario'action = "alteraDadosFuncionarios.php" enctype = "multipart/form-data">
